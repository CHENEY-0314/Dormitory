...
import com.example.dormitory.Administrator.Adapters.admSectionsPagerAdapter;
import com.example.dormitory.Administrator.admMainPageActivity.admMainPage;
import com.example.dormitory.Administrator.admMyPageActivity.admMyPage;
import com.example.dormitory.Administrator.admReleasePageActivity.admReleasePage;
import com.example.dormitory.R;
import java.util.ArrayList;
import java.util.List;

public class admTabbar extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adm_bottomtabbar_layout);

        bottomNavigationBar = findViewById(R.id.adm_bottom_navigation_bar);

        viewPager = findViewById(R.id.adm_viewPager);
        //将所有的fragment放入一个ArrayList中
        fragmentList = new ArrayList<Fragment>();
        Fragment f1 = new admMainPage();
        Fragment f2 = new admReleasePage();
        Fragment f3 = new admMyPage();
        fragmentList.add(f1);
        fragmentList.add(f2);
        fragmentList.add(f3);
        FragmentManager fragmentManager = getSupportFragmentManager();
        admSectionsPagerAdapter myPagerAdapter = new admSectionsPagerAdapter(fragmentManager, fragmentList);
